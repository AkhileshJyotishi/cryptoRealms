...
const HouseCardHori = ({ property }: IHouseCardHoriProps) => {
  return (
    <div className="w-full justify-between flex gap-4 bg-[#ffffff49] rounded-xl border-[1px] border-[#fff] backdrop-blur-[6px] shadow-[0_4px_30px_0_rgba(0,0,0,0.1)] p-3">
      <div>
        <Image
      ...
      <div className="flex flex-col items-end justify-between">
        <span className="bg-black font-[500] text-white px-2 py-1 rounded-full">
