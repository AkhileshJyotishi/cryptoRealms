...
export default function Home() {
  return (
    <main className="bg-gradient-to-b from-[#C44816] to-[#F8EC7D] max-w-[1660px] mx-auto w-[90%] flex min-h-screen flex-col items-center justify-between p-24">
      <div className="grid gap-6 grid-cols-2 sm:grid-cols-3 place-items-center m-4">
